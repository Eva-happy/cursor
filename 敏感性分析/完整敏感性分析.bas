...
Private Sub FormatWorksheet(ByVal ws As Worksheet)
    ...
    With ws
        ...
        .Range("B3:AL13").HorizontalAlignment = xlCenter
        ...
        .Range("D4:G13").NumberFormat = "0.00%" ' IRR列
        .Range("H4:H13").NumberFormat = "0.00"  ' 敏感系数列
        ...
        .Range("L4:O13").NumberFormat = "0.00%" ' IRR列
        .Range("P4:P13").NumberFormat = "0.00"  ' 敏感系数列
        ...
        .Range("T4:U13").NumberFormat = "0.00"  ' 回收期列
        .Range("V4:V13").NumberFormat = "0.00%" ' 参数变化率列
        .Range("W4:W13").NumberFormat = "0.00%" ' 回收期变化率列
        .Range("X4:X13").NumberFormat = "0.00"  ' 敏感系数列
        ...
        .Range("AB4:AC13").NumberFormat = "0.00"  ' 回收期列
        .Range("AD4:AD13").NumberFormat = "0.00%" ' 参数变化率列
        .Range("AE4:AE13").NumberFormat = "0.00%" ' 回收期变化率列
        .Range("AF4:AF13").NumberFormat = "0.00"  ' 敏感系数列
        
                ' 设置数字格式 - 第五个表格（汇总表）
        .Range("AI4:AL13").NumberFormat = "0.00"  ' 敏感系数列
        
        ' 清除所有边框
        .Range("B2:AF13").Borders.LineStyle = xlNone
        
        ' 设置外框粗边框
        With .Range("B2:H13").Borders(xlEdgeLeft)
            .LineStyle = xlContinuous
            .Weight = xlMedium
        End With
        With .Range("B2:H13").Borders(xlEdgeRight)
            .LineStyle = xlContinuous
            .Weight = xlMedium
        End With
        With .Range("B2:H13").Borders(xlEdgeTop)
            .LineStyle = xlContinuous
            .Weight = xlMedium
        End With
        With .Range("B2:H13").Borders(xlEdgeBottom)
            .LineStyle = xlContinuous
            .Weight = xlMedium
        End With
        ...
        ' 设置内部单元格细边框
        .Range("B3:H13").Borders(xlInsideHorizontal).LineStyle = xlContinuous
        .Range("B3:H13").Borders(xlInsideVertical).LineStyle = xlContinuous
        
        ' 对其他三个表格应用相同的格式
        ' 资本金IRR表格
        With .Range("J2:P13").Borders(xlEdgeLeft)
            .LineStyle = xlContinuous
            .Weight = xlMedium
        End With
        With .Range("J2:P13").Borders(xlEdgeRight)
            .LineStyle = xlContinuous
            .Weight = xlMedium
        End With
        With .Range("J2:P13").Borders(xlEdgeTop)
            .LineStyle = xlContinuous
            .Weight = xlMedium
        End With
        With .Range("J2:P13").Borders(xlEdgeBottom)
            .LineStyle = xlContinuous
            .Weight = xlMedium
        End With
        With .Range("J2:P2").Borders(xlEdgeBottom)
            ...
            .Weight = xlMedium
        End With
        .Range("J3:P13").Borders(xlInsideHorizontal).LineStyle = xlContinuous
        .Range("J3:P13").Borders(xlInsideVertical).LineStyle = xlContinuous
        
        ' 全投回收期表格
        With .Range("R2:X13").Borders(xlEdgeLeft)
            .LineStyle = xlContinuous
            .Weight = xlMedium
        End With
        With .Range("R2:X13").Borders(xlEdgeRight)
            .LineStyle = xlContinuous
            .Weight = xlMedium
        End With
        With .Range("R2:X13").Borders(xlEdgeTop)
            .LineStyle = xlContinuous
            .Weight = xlMedium
        End With
        With .Range("R2:X13").Borders(xlEdgeBottom)
            .LineStyle = xlContinuous
            .Weight = xlMedium
        End With
        With .Range("R2:X2").Borders(xlEdgeBottom)
            ...
            .Weight = xlMedium
        End With
        .Range("R3:X13").Borders(xlInsideHorizontal).LineStyle = xlContinuous
        .Range("R3:X13").Borders(xlInsideVertical).LineStyle = xlContinuous
        
        ' 资本金回收期表格
        With .Range("Z2:AF13").Borders(xlEdgeLeft)
            .LineStyle = xlContinuous
            .Weight = xlMedium
        End With
        With .Range("Z2:AF13").Borders(xlEdgeRight)
            .LineStyle = xlContinuous
            .Weight = xlMedium
        End With
        With .Range("Z2:AF13").Borders(xlEdgeTop)
            .LineStyle = xlContinuous
            .Weight = xlMedium
        End With
        With .Range("Z2:AF13").Borders(xlEdgeBottom)
            .LineStyle = xlContinuous
            .Weight = xlMedium
        End With
        With .Range("Z2:AF2").Borders(xlEdgeBottom)
            ...
            .Weight = xlMedium
        End With
        .Range("Z3:AF13").Borders(xlInsideHorizontal).LineStyle = xlContinuous
        .Range("Z3:AF13").Borders(xlInsideVertical).LineStyle = xlContinuous
